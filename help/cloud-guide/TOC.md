...
breadcrumb-title: Commerce su Cloud
...
+ [Introduzione](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/start/overview)
+ Note sulla versione {#release-notes}
  ...
  + {hide-from-toc}[Archivio note sulla versione](release-notes/cloud-release-archive.md)
...
+ Sviluppo {#develop}
  ...
  + Storage {#storage}
    ...
    + [Verifica il limite di spazio su disco per Adobe Commerce sull’infrastruttura cloud](storage/check-disk-space-limit-on-cloud.md)
...
+ Servizi Fastly {#cdn}
  ...
  + [Sicurezza avanzata](cdn/advanced-security.md)
...
+ Monitorare il sito {#monitor}
  ...
  + servizio New Relic {#new-relic}
    ...
    + Approfondimenti traffico {#traffic-insights}
      + [Panoramica](monitor/traffic-insights/overview.md)
      + [Informazioni sull’app](monitor/traffic-insights/understanding-the-app.md)
      + [Playbook di investigazione](monitor/traffic-insights/investigation-playbook.md)
