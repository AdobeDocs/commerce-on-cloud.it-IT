...
- ![icona di correzione](../../assets/fix.svg) **Patch**-Correzione per checkout interrotto (AC-15867) e newrelic (ACSD-68617).<!-- MCLOUD-14191 -->
...
- ![icona correzione](../../assets/fix.svg) **Visualizzazione categorie migliorata**-MCLOUD-13752:Improve.<!-- MCLOUD-13752 | MCLOUD-14139  - -->
