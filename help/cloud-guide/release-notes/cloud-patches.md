...
- ![icona di correzione](../../assets/fix.svg) **Patch** - Correzione per [L&#39;estrazione non riesce quando la minimizzazione JS e il bundling sono abilitati](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-27997)) problema descritto in *Commerce Knowledgebase&quot; (ticket AC-15867 e ACSD-68617).<!-- MCLOUD-14191 -->
